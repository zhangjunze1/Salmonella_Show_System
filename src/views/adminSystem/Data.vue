...
export default {
  ...
  methods: {
    ...
    async downloadCsv () {
      const { data } = await findDownloadDataRetrievalList(this.form.Year, this.form.Province, this.form.Serotype, window.sessionStorage.getItem('admin'))
    ...
    async downloadData () {
      const { data } = await DownloadDataRetrievalList(this.pageIndex, this.pageSize, this.form.Year, this.form.Province, this.form.Serotype, window.sessionStorage.getItem('admin'))
      console.log(data)
    ...
    async getSerotypeList () {
      const { data } = await findInitDataList(window.sessionStorage.getItem('admin'))
    ...
    async getQuery () {
      const { data } = await findDataRetrievalList(this.pageIndex, this.pageSize, this.form.Year, this.form.Province, this.form.Serotype, window.sessionStorage.getItem('admin'))
